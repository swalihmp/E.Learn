...
export default function SingleCourse() {
    ...
    //     if(user_auth)
    //     {
    //         console.log(id,user_name.user_id)
    //         axios.post(`${BASE_URL}/cart/addcart/${id}/${user_name.user_id}`)
    //         .then(()=>getCourse())
    //     }
    //     else{
    //         navigate('/login',{state:{msgerror:"Pls Login First...."}})
    //     }
    // }
            ...
            <div className="w-full h-full py-5  flex  place-content-start px-14">
                ...
                <div className="shadow-xl bg-white absolute rounded-xl right-36 h-auto px-1 py-8 w-80 flex-col flex gap-8 place-items-center">
                    ...
                    <div className="flex gap-3 place-content-center">
                        ...
                        <p className='text-3xl font-normal line-through text-gray-600'>{'₹ '+SingleCourse.price}</p>
                    </div>
                    {
                        
                            Active&&Cart ?
                            <div className="w-full px-3 flex place-content-center">
                                <button className=' text-white px-5 py-3 w-full bg-bgcart' onClick={()=>goTocart()} >Go to cart</button>
                            </div>
                            :enrolled?
                            <div className="w-full px-3 flex place-content-center">
                                <button className=' text-white px-5 py-3 w-full bg-bgcart' >Start Course</button>
                            </div>
                            :
                            <div className="w-full px-3 flex place-content-center">
                                <button className=' text-white px-5 py-3 w-full bg-bgcart' onClick={e => addCart(e,user_name.user_id,SingleCourse.id,SingleCourse.saleprice)}>Add To Cart</button>
                            </div>
                    }

      ...
      <div className='flex flex-col p-5'>
        <div className='w-full h-40 rounded-xl flex flex-col shadow-xl overflow-hidden bg-white'>
          ...
          <div className='ml-5 mt-5 flex flex-col'>
            <p className='text-md font-semibold'>Current Lucture :  {current?.title} , {current?.type}</p>
            <p className='text-md font-semibold mt-1'>Pls complete the lecture/note to move next tutuorial..... </p>
          </div>
        </div>
      </div>
      <div className="w-full flex gap-2 h-full ">
                    <div className="w-3/4 ml-2 flex flex-col">
                      <ReactPlayer width="1080px" height="960px" url={details+video}  controls={true} config={{
                        file: {
                          attributes: {
                                  ...
                                  <TabsBody>
                                      ...
                                      <TabPanel key="instructor" value="instructor">
                                          <div className="w-full shadow-lg p-5  h-36 rounded-xl">
                                              ...
                                              <div className="p-5">
                                                  <p className='text-sm text-gray-600 '>2+ Year Experiance Python-Django FUll stack developer with high specialized in React Js</p>
                                              </div>
                                      ...
                                      <TabPanel key="reviews" value="reviews">
                                            ...
                                            {/* <div className="flex gap-2 place-items-center">
                                                  <div className="w-20">
                                                      <img className='w-14 h-14' src= '/tutor_avatar.png'  alt="tutor_profile"/>
                                                  </div>
                                                  <div className="flex flex-col gap-3 place-content-start">
                                                      <h1 className='flex gap-3 font-poppins text-xl font-semibold text-black'>Swalihmp</h1>
                                                  </div>
                                              </div> */}

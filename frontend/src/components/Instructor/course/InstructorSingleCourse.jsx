    ...
    <div className='flex h-full bg-acontent'>
        ...
        <div className='px-5 w-full h-auto min-h-screen mx-5 mt-2  py-8 font-poppins flex flex-col         place-content-start place-items-center bg-white shadow-xl rounded-xl'>
            <div className='flex place-content-between place-items-center w-full h-14'>
                ...
                <div className=''>
                    {
                    SingleCourse.is_rejected || !SingleCourse.is_active ?
                    <button onClick={() => Resubmit(SingleCourse.id)} className='bg-cards rounded-lg text-center px-5 py-2 text-white text-light'>Apply For Approval</button>
                    :
                    null
                    }
                    <button onClick={()=>goTocreate()} className='bg-cards rounded-lg text-center ml-5 px-5 py-2 text-white text-light'>Create Course</button>
                </div>
                ...
                <div className="w-full h-full py-5  flex  place-content-start px-14">
                    ...
                    <div className=' pl-10'>
                        <div className='p-6 rounded-md w-full h-60'>
                            <video className='w-full h-full' src={details+SingleCourse.video} controls></video>
                        </div>
                    </div>
                </div>
            </div>
...

{
                                ...
                                <div className=' flex place-content-center place-items-center pt-5'>
                                    <button className='bg-cards rounded-lg text-center px-5 py-2 text-white text-light' onClick={()=>setToggle({add:true})}>Add Sesion</button>
                                </div>
                            </TabPanel>
                            ...
                            <div className="w-full flex flex-col gap-3">
                                ...
                                <div className=' flex w-full place-content-center place-items-center pt-5'>
                                    <button className='bg-cards rounded-lg text-center px-5 py-2 text-white text-light' onClick={()=>setToggle({addmaterial:true})}>Add Material</button>
                                </div>
                            </TabPanel>
                            ...
                            {/* 
                                <div className=' w-full rounded-xl mb-5 shadow-xl bg-white h-32'>
                                    <div className=' m-5 flex flex-row gap-5'>
                                    <img className='w-14 rounded-xl' src='/avatar1.avif' alt="User Profile"/>
                                    <p className=' font-bold mt-4'>{review.user.username}</p>
                                    <p className='font-bold mt-4'>{review.rating}/5</p>
